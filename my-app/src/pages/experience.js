            ...
            <div className="relative z-10 flex flex-col items-center w-full">
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        {showCongrats && (
                            <div 
                                className="mb-8 p-4 bg-white bg-opacity-90 rounded-lg shadow-lg"
                                style={{
                            ...
                            >
                                <h2 className="text-2xl font-bold text-indigo-700 mb-2">대화 완료!</h2>
                                <p className="text-gray-700">
                                    훌륭해요! {difficulty}단계 대화를 성공적으로 마쳤습니다.
                                    <br/>경험치 {targetXP}을 획득하셨습니다!
                                </p>
                            </div>
                        )}
